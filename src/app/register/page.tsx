...
const SignUp = () => {
  ...
  const handleSubmit = async (values: typeof initialValues) => {
    try {
      ...
      toast.success('Signup successful! Welcome to Naukri.com');
  ...
  return (
    <div className="bg-gray-3 py-1 md:py-6 px-2">
      <div className="max-w-[600px] mx-auto bg-white shadow-1 rounded-xl my-6 h-fit pt-6 pb-5 px-3 md:px-6">
        ...
        >
          {({ isSubmitting, touched, errors }) => (
            <Form className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                className="w-full md:w-fit bg-[#F05537] md:bg-blue-1 py-2 px-6 rounded-full text-white font-semibold"
